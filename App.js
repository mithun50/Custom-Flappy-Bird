          ...
          {gameState === 'waiting' && messageImg && (
            <>
              ...
              <Group>
                ...
                <Group clip={rrect(rect(width / 2 - 75, height - 290, 150, 40), 8, 8)}>
                  <Group>
                    <Circle cx={width / 2} cy={height - 270} r={80} color="#2C5F2D" />
                  </Group>
                </Group>

                {/* Border outline */}
                <Group>
                  <Group clip={rrect(rect(width / 2 - 76, height - 291, 152, 42), 8, 8)}>
                    <Circle cx={width / 2} cy={height - 270} r={82} color="rgba(0,0,0,0)" style="stroke" strokeWidth={2} />
                  </Group>
                  <Group clip={rrect(rect(width / 2 - 75, height - 290, 150, 40), 8, 8)} style="stroke">
                    <Circle cx={width / 2} cy={height - 270} r={80} color="#FFD700" style="stroke" strokeWidth={2} />
                  </Group>
                </Group>
              ...
              {/* Custom Image Button - Round */}
              <Group>
                {customBird && birdColor === 'custom' ? (
                  <>
                    {/* Circular glow background when selected */}
                    <Circle
                      cx={310}
                      cy={height - 170}
                      r={32}
                    ...
                    {/* Circular clipped custom image */}
                    <Group clip={rrect(rect(280, height - 200, 60, 60), 30, 30)}>
                      <Image
                        image={customBird}
                        x={280}
                        y={height - 200}
